...
int main()
{
	...
	int menu_terpilih, d=0, e=0, f=0, g=0;
	...
	while(1) {
		...
		switch (menu_terpilih) {
			case 1:
				{
					d++;
					string nama, id, nrp, departemen, matakuliah;
					...
					cin>>skslulus;
					cout<<"Input Mata kuliah (Matkul 1, Matkul 2, ....): ";
					cin.ignore();
					getline(cin,matakuliah);

					mahasiswa MAHASISWA( id,nama, dd, mm, yy, nrp, departemen, tahunmasuk, semesterke, skslulus, matakuliah);
			...
			case 4:
				{
					...
					while(i<d)
					{
						...
						cout<<"Mata kuliah :"<<recMhs[i].getMatakuliah()<<endl;
						cout<<endl;
						i++;
					}	
				}
			...
			case 7:
				{
					...
					int sks;
					cout<<"Input Nama Matkul: ";
					cin.ignore();
					getline(cin,namamatkul);
					cout<<"Input Nama Dosen Pengampu: ";
					cin.ignore();
					getline(cin,namadosen);
					cout<<"Input Beban SKS (dalam angka): ";
					cin>>sks;

					matkul MATKUL( namamatkul,namadosen, sks);
			...
			case 8:
				{
					...
					while(i<g)
					{
						cout<<"Nama Matakuliah :"<<recMatkul[i].getNamamatkul()<<endl;
						cout<<"Nama dosen pengampu :"<<recMatkul[i].getNamadosen()<<endl;
						cout<<"Beban sks :"<<recMatkul[i].getSks()<<endl;
						cout<<endl;
						i++;
					}
				}
			...
			default:
			{
				cout<<"pilihan Anda tidak ada dalam menu, silahkan pilih kembali"<<endl;
			}
			break;
